...
*В приложеном Vagrantfile отсутствует машина Ansible, чтобы проект был реализован ее надо добавить или создать отдельно просто как новую ВМ в VirtualBox или аналог как делал я сам, создавал ее в таком виде только для удобства раскатки плэйбуков проекта*
